...
- ตัวอย่างที่ 15: บรรทัดที่ 3 `console.log(product[propertyName` ไม่มีวงเล็บปิด `]` และ `)` รวมทั้งไม่มีเครื่องหมายอัฒภาค (;) ปิดท้าย ตามที่ปรากฏในต้นฉบับหนังสือ (หน้า 332) จึงคงไว้ตามเดิมโดยไม่แก้ไข
